...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Translate missing Board English fields with GPT.")
...
def translate_boards(base_url: str, import_key: str, limit: int) -> int:
    endpoint = f"{base_url.rstrip('/')}/api/v1/admin/data-import/board-translations"
